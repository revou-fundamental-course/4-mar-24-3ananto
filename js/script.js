...
const BMI_CATEGORIES = {
  ...
  // Fungsi untuk cetak hasil perhitungan BMI
  document.getElementById('printButton').addEventListener('click', function() {
    window.print(); // Untuk memanggil fungsi print bawaan browser
  });
  ...
  // Fungsi untuk menampilkan alert pengganti Link
  function showAlert() {
    alert("Link menuju web Konsultasi dengan Ahli Gizi via Aplikasi");
  }
  function showAlert2() {
    alert("Link menuju Form Registrasi Konsultasi Online dengan Ahli Gizi via Aplikasi");
  }
  ...
  const checkBMI = () => {
    ...
    var result = window.confirm("Apakah Anda yakin data yang Anda masukkan sudah benar ? Klik OK untuk melanjutkan.");
    if (result) {
  ...
  // Sumber Informasi:
  // Resiko Penyakit Kekurangan Berat Badan: https://www.alodokter.com/faktor-penyebab-badan-kurus-dan-tips-sehat-untuk-mengatasinya/ Diakses pada 14 Maret 2024
  // Resiko Penyakit Kelebihan Berat Badan: https://health.detik.com/diet/d-4771038/7-penyakit-ini-bersembunyi-di-balik-berat-badan-berlebih/ Diakses pada 14 Maret 2024
  // Resiko Penyakit Obesitas: https://www.halodoc.com/kesehatan/obesitas/  Diakses pada 14 Maret 2024